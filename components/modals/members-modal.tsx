            ...
            <DialogContent className="bg-white text-black overflow-hidden">
                ...
                <ScrollArea className="mt-8 max-h-[420px] pr-6">
                    {server?.members?.map((members) =>(
                        <div key={members.id} className="flex items-center gap-x-2 mb-6">
                            <UserAvatar src={members.profile.imageUrl}/>
                            <div className="flex flex-col gap-y-1">
                                <div className="text-xs font-semibold flex items-center gap-x-1">
                                    {members.profile.name}
                                    {roleIconMap[members.role]}
                                </div>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent side="left">
                                            <DropdownMenuSub>
                                                ...
                                                <DropdownMenuPortal>
                                                    <DropdownMenuSubContent>
                                                        <DropdownMenuItem onClick={() => onRoleChange(members.id, "GUEST")}>
                                                        ...
                                                        <DropdownMenuItem onClick={() => onRoleChange(members.id, "MODERATOR")}>
